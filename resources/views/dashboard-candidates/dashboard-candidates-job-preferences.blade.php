                                ...
                                <form class="form-row">
                                    ...
                                    <div class="form-group col-md-4 select-border">
                                        <select class="form-control">
                                            ...
                                            <option value="value 02">Weekly</option>
                                            <option value="value 03">Daily</option>
                                            <option value="value 01">Hourly</option>
                                            <option value="value 02">Yearly</option>
                                            <option value="value 03">One-Off</option>
                                        </select>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group mb-2">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text max-select" style="width:86px;">
                                                    RM
                                                </div>
                                            </div>
